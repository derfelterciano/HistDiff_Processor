...
<div class="multi-control">
  ...
  <div class="control-list mb-2 px-4 w-full">
    {#each controls as _, index}
      <div class="control-row flex items-center gap-x-1 mb-2">
        ...
        <button
          type="button"
          class="cursor-pointer flex-none justify-self-start w-auto bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-3 rounded"
  ...
  <button
    type="button"
    class="cursor-pointer bg-blue-500 hover:bg-blue-600 text-center px-4 rounded-md"
